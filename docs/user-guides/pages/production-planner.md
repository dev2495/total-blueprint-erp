...
## Summary (EN)
Use this page to plan, assign, execute, and close production tasks.

## Summary (HI)
इस पेज का उपयोग उत्पादन कार्यों की योजना, असाइनमेंट, निष्पादन और क्लोज़ करने के लिए करें।

## Purpose (EN)
This guide helps users complete all key tasks on Production • Planner without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Production • Planner पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![production-planner-overview](../../../frontend_v2/public/help/screenshots/production-planner-overview.svg)
