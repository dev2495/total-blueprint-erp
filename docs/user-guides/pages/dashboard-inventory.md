...
## Purpose (EN)
This guide helps users complete all key tasks on Dashboard • Inventory without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Dashboard • Inventory पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![dashboard-inventory-overview](../../../frontend_v2/public/help/screenshots/dashboard-inventory-overview.svg)
- ![dashboard-inventory-workflow](../../../frontend_v2/public/help/screenshots/dashboard-inventory-workflow.svg)
