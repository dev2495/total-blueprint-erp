...
## Summary (EN)
Use this dashboard to monitor live KPIs, exceptions, and quick actions.

## Summary (HI)
इस डैशबोर्ड का उपयोग लाइव KPI, अपवाद और त्वरित कार्यों को मॉनिटर करने के लिए करें।

## Purpose (EN)
This guide helps users complete all key tasks on Dashboard • Engineering without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Dashboard • Engineering पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
1. Identify Alert Severity
   - Outcomes: Critical, Operational
2. Execute Assigned Action
   - Outcomes: Resolved, Blocked
...
- ![dashboard-engineering-overview](../../../frontend_v2/public/help/screenshots/dashboard-engineering-overview.svg)
- ![dashboard-engineering-workflow](../../../frontend_v2/public/help/screenshots/dashboard-engineering-workflow.svg)
