...
## Summary (EN)
Inter-Plant Report gives owners and managers report-ready numbers with traceable filters and export context.

## Summary (HI)
Inter-Plant Report स्क्रीन उपयोगकर्ताओं को सही डेटा, स्थिति और अगला कार्य स्पष्ट रूप से दिखाती है।

## Purpose (EN)
Use Inter-Plant Report to complete the page workflow without guessing which status, filter, or approval step comes next.

## Purpose (HI)
Inter-Plant Report का उपयोग करके अगला status, filter या approval step बिना भ्रम के पूरा करें।
