...
## Summary (EN)
Report Center keeps governance, audit, users, and report controls visible to owner/admin roles.

## Summary (HI)
Report Center स्क्रीन उपयोगकर्ताओं को सही डेटा, स्थिति और अगला कार्य स्पष्ट रूप से दिखाती है।

## Purpose (EN)
Use Report Center to complete the page workflow without guessing which status, filter, or approval step comes next.

## Purpose (HI)
Report Center का उपयोग करके अगला status, filter या approval step बिना भ्रम के पूरा करें।
