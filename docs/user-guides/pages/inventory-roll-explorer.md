...
## Summary (EN)
Use this page to validate stock positions, movements, and traceability events.

## Summary (HI)
इस पेज का उपयोग स्टॉक स्थिति, मूवमेंट और ट्रेसबिलिटी इवेंट की पुष्टि करने के लिए करें।

## Purpose (EN)
This guide helps users complete all key tasks on Inventory • Roll Explorer without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Inventory • Roll Explorer पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![inventory-roll-explorer-overview](../../../frontend_v2/public/help/screenshots/inventory-roll-explorer-overview.svg)
- ![inventory-roll-explorer-workflow](../../../frontend_v2/public/help/screenshots/inventory-roll-explorer-workflow.svg)
