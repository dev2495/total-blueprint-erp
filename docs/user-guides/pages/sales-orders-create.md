...
## Purpose (EN)
This guide helps users complete all key tasks on Sales • Orders • Create without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Sales • Orders • Create पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![sales-orders-create-overview](../../../frontend_v2/public/help/screenshots/sales-orders-create-overview.svg)
- ![sales-orders-create-workflow](../../../frontend_v2/public/help/screenshots/sales-orders-create-workflow.svg)
