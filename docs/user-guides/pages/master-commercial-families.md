...
## Summary (EN)
Commercial Families maintains commercial master data used by sales, costing, and planning.

## Summary (HI)
Commercial Families स्क्रीन उपयोगकर्ताओं को सही डेटा, स्थिति और अगला कार्य स्पष्ट रूप से दिखाती है।

## Purpose (EN)
Use Commercial Families to complete the page workflow without guessing which status, filter, or approval step comes next.

## Purpose (HI)
Commercial Families का उपयोग करके अगला status, filter या approval step बिना भ्रम के पूरा करें।
