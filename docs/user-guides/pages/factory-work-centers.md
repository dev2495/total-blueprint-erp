...
## Summary (EN)
Use this page to configure physical factory structure and execution entities.

## Summary (HI)
इस पेज का उपयोग फैक्टरी की भौतिक संरचना और निष्पादन इकाइयों को कॉन्फ़िगर करने के लिए करें।

## Purpose (EN)
This guide helps users complete all key tasks on Factory • Work Centers without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Factory • Work Centers पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
1. Check dependency chain
   - Outcomes: Dependencies ready, Missing masters
2. Save and verify mappings
   - Outcomes: Verified
