...
## Purpose (EN)
This guide helps users complete all key tasks on Inventory • Packaging without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Inventory • Packaging पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![inventory-packaging-overview](../../../frontend_v2/public/help/screenshots/inventory-packaging-overview.svg)
- ![inventory-packaging-workflow](../../../frontend_v2/public/help/screenshots/inventory-packaging-workflow.svg)
