...
## Purpose (EN)
This guide helps users complete all key tasks on Inventory • Grn without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Inventory • Grn पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![inventory-grn-overview](../../../frontend_v2/public/help/screenshots/inventory-grn-overview.svg)
- ![inventory-grn-workflow](../../../frontend_v2/public/help/screenshots/inventory-grn-workflow.svg)
