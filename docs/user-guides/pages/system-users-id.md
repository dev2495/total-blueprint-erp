...
## Summary (EN)
Use this page to manage users, access controls, and governance approvals.

## Summary (HI)
इस पेज का उपयोग उपयोगकर्ता, एक्सेस कंट्रोल और गवर्नेंस अनुमोदन प्रबंधित करने के लिए करें।

## Purpose (EN)
This guide helps users complete all key tasks on System • Users • Details without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को System • Users • Details पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
1. Validate policy scope
   - Outcomes: Valid, Invalid
2. Approve with notes
   - Outcomes: Done
3. Reject with action items
   - Outcomes: Returned
...
- ![system-users-id-overview](../../../frontend_v2/public/help/screenshots/system-users-id-overview.svg)
- ![system-users-id-workflow](../../../frontend_v2/public/help/screenshots/system-users-id-workflow.svg)
