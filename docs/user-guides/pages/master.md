...
## Summary (EN)
Use this page to maintain controlled master data used by downstream transactions.

## Summary (HI)
इस पेज का उपयोग डाउनस्ट्रीम लेनदेन में उपयोग होने वाले मास्टर डेटा को नियंत्रित रूप से बनाए रखने के लिए करें।

## Purpose (EN)
This guide helps users complete all key tasks on Master without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Master पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![master-overview](../../../frontend_v2/public/help/screenshots/master-overview.svg)
