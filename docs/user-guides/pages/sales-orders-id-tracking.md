...
## Summary (EN)
Use this page to create, track, and fulfill customer-facing commercial commitments.

## Summary (HI)
इस पेज का उपयोग ग्राहक-उन्मुख वाणिज्यिक प्रतिबद्धताओं को बनाने, ट्रैक करने और पूरा करने के लिए करें।

## Purpose (EN)
This guide helps users complete all key tasks on Sales • Orders • Details • Tracking without process ambiguity.

## Purpose (HI)
यह गाइड उपयोगकर्ताओं को Sales • Orders • Details • Tracking पर सभी मुख्य कार्य बिना प्रक्रिया भ्रम के पूरा करने में मदद करती है।
...
- ![sales-orders-id-tracking-overview](../../../frontend_v2/public/help/screenshots/sales-orders-id-tracking-overview.svg)
- ![sales-orders-id-tracking-workflow](../../../frontend_v2/public/help/screenshots/sales-orders-id-tracking-workflow.svg)
