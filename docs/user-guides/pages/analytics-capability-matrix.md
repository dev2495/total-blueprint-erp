...
## Summary (EN)
Capability Matrix gives owners and managers report-ready numbers with traceable filters and export context.

## Summary (HI)
Capability Matrix स्क्रीन उपयोगकर्ताओं को सही डेटा, स्थिति और अगला कार्य स्पष्ट रूप से दिखाती है।

## Purpose (EN)
Use Capability Matrix to complete the page workflow without guessing which status, filter, or approval step comes next.

## Purpose (HI)
Capability Matrix का उपयोग करके अगला status, filter या approval step बिना भ्रम के पूरा करें।
...
- ![analytics-capability-matrix-overview](../../../frontend_v2/public/help/screenshots/analytics-capability-matrix-overview.svg)
- ![analytics-capability-matrix-workflow](../../../frontend_v2/public/help/screenshots/analytics-capability-matrix-workflow.svg)
