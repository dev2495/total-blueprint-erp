...
## Overview (EN)
Plant Manager is responsible for secure, policy-compliant execution in assigned ERP modules.

## Overview (HI)
Plant Manager की जिम्मेदारी है कि निर्धारित ERP मॉड्यूल में सुरक्षित और नीति-अनुपालन निष्पादन हो।
...
## Core Workflows (EN)
- Start from /analytics, execute primary queue actions, and confirm status transitions.
- Use Help decision flow before forcing overrides or exception closures.


## Core Workflows (HI)
- /analytics से शुरू करें, प्राथमिक कतार कार्य निष्पादित करें, और स्थिति परिवर्तन पुष्टि करें।
...
- ![role-plant_manager-landing](../../../frontend_v2/public/help/screenshots/role-plant_manager-landing.svg)
