...
urlpatterns = [
    ...
    path('audit-ledger/', AnalyticsViewSet.as_view({'get': 'audit_ledger'}), name='analytics-audit-ledger'),
    path('audit-ledger/<str:event_id>/', AnalyticsViewSet.as_view({'get': 'audit_event_detail'}), name='analytics-audit-event-detail'),
