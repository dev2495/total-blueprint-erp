...
DEFAULT_EVENT_ROUTING = {
    ...
    "production.next_step_ready": {"roles": ["WORK_CENTER_MANAGER"], "channels": ["IN_APP"], "priority": "NORMAL"},
    "production.machine_ready": {"roles": ["WORK_CENTER_MANAGER"], "channels": ["IN_APP"], "priority": "NORMAL"},
