...
SAMPLE_INBOX_ROWS = [
    {
        "event_key": "sales.order_created",
        "target_role": "SALES",
        "title": "New commercial order captured",
        "message": "A customer order was created and is ready for confirmation, pricing, or follow-up.",
        "type": "ORDER_CREATED",
        "priority": "NORMAL",
    },
    {
    ...
    {
        "event_key": "production.next_step_ready",
        "target_role": "WORK_CENTER_MANAGER",
        "title": "Roll is ready for the next process step",
        "message": "A completed upstream job produced stock that can now be moved to the next work center.",
        "type": "SYSTEM",
        "priority": "NORMAL",
    },
    {
    ...
    {
        "event_key": "production.job_completed",
        "target_role": "STORE",
        "title": "Production job completed",
        "message": "A production job closed successfully and output is ready for stock posting or next-step movement.",
        "type": "JOB_COMPLETE",
        "priority": "NORMAL",
    },
    {
        "event_key": "production.wip_ready",
        "target_role": "PLANNER",
        "title": "Intermediate WIP is available",
        "message": "A stopped-route or invariant WIP batch is now available for continuation or stock claim decisions.",
        "type": "SYSTEM",
        "priority": "NORMAL",
    },
    {
    ...
    {
        "event_key": "inventory.item_created",
        "target_role": "STORE",
        "title": "New item master is ready for use",
        "message": "A new inventory item was created and is now available for receipts, issues, and planning.",
        "type": "SYSTEM",
        "priority": "NORMAL",
    },
    {
        ...
        "message": "A stock transfer was created and is waiting for dispatch action and document preparation.",
        "type": "DISPATCH_READY",
        "priority": "HIGH",
    },
    {
    ...
    {
        "event_key": "logistics.dispatch_completed",
        "target_role": "SALES",
        "title": "Customer dispatch completed",
        "message": "The dispatch leg was completed and the sales team can track the delivery against customer commitment.",
        "type": "DISPATCH_READY",
        "priority": "NORMAL",
    },
    {
    ...
    },
    {
        ...
        "target_role": "ADMIN",
        "title": "Daily report pack ready",
        "message": "The daily report pack was generated, archived, and is ready for owner/admin review in the system.",
        "type": "SYSTEM",
        "priority": "NORMAL",
    },
    {
        ...
        "message": "A daily report pack failed during generation and needs admin review before the next archive cycle.",
        "type": "SYSTEM",
        "priority": "HIGH",
    },
]
