 ...
 */
export function pickOrderPlacedDate(order: Record<string, any> | null | undefined): string | null {
 ...
 *   // age.tone === "normal"
 */
export function orderAge(input: Record<string, any> | string | Date | null | undefined): OrderAgeResult {
    const dateStr =
        input == null
            ? null
    ...
    if (!dateStr) {
        return { label: "—", shortLabel: "—", days: null, placedOn: null, tone: "normal" }
    }
    ...
    return {
        ...
        shortLabel,
        days,
        placedOn: d.toLocaleDateString(undefined, { day: "2-digit", month: "short", year: "numeric" }),
        tone,
    }
}
...
export const ORDER_AGE_TONE_CLASSES: Record<OrderAgeTone, string> = {
    ...
    ancient: "bg-rose-50 text-rose-700 ring-rose-200",
}
