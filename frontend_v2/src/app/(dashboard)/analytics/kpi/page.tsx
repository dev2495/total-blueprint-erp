        ...
        <CardContent>
          <div className="h-64 flex items-center justify-center bg-muted/20 rounded-lg">
            <p className="text-muted-foreground">
              Chart placeholder - KPI trend visualization
            </p>
          </div>
        </CardContent>
      </Card>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t">
                  ...
                  <td className="p-3">
                    <span className="px-2 py-1 bg-warning-bg text-warning-fg rounded text-xs">
                      Near Target
                    </span>
                  </td>
                </tr>
                ...
                <tr className="border-t">
                  ...
                  <td className="p-3">
                    <span className="px-2 py-1 bg-success-bg text-success-fg rounded text-xs">
                      On Target
                    </span>
                  </td>
                </tr>
