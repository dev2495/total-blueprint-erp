            ...
            <div className="flex flex-col">
                ...
                <div className="flex items-center gap-1.5 mt-1">
                    {row.original.created_from === 'CUSTOM_ORDER' ? (
                        <Badge variant="destructive" className="text-[10px] py-0 h-4 px-1.5 uppercase font-black tracking-tighter">
                            Custom Order
                        </Badge>
                    ) : (
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="text-right">
                <Button asChild variant="ghost" size="sm" className="group h-8 hover:bg-primary/10 hover:text-primary">
                    <Link href={`/engineering/approvals/${row.original.id}`} className="flex items-center">
                        Review Engineering
