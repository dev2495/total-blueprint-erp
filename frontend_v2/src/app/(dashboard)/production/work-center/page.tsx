        ...
        return (
            <div className="flex h-screen items-center justify-center bg-[#f8fafc]">
                <div className="text-center space-y-4">
                    <Activity className="h-12 w-12 animate-pulse text-indigo-600 mx-auto" />
        ...
        <div className="p-8 lg:p-12 space-y-10 bg-[#f8fafc] min-h-screen">
            ...
            <div className="max-w-4xl mx-auto text-center space-y-1">
                ...
                <h1 className="text-5xl font-black tracking-tighter text-slate-900">
                    Floor <span className="text-indigo-600 italic">Access</span> Point
                </h1>
                <p className="text-slate-500 font-medium text-sm flex items-center justify-center gap-2 mt-2 uppercase tracking-widest">
                    Select a validated work center terminal to begin operations <Activity className="h-4 w-4 text-indigo-400" />
                </p>
                        ...
                        <Card className={`border-none shadow-premium hover:shadow-premium-hover rounded-[3rem] overflow-hidden bg-white/70 backdrop-blur-md transition-all duration-500 relative h-full ${isLastUsed ? "ring-2 ring-emerald-200 border border-emerald-300/50" : ""}`}>
                            <CardHeader className="flex flex-row items-center justify-between p-10 pb-6">
                                <div>
                                    ...
                                    <CardTitle className="text-3xl font-black tracking-tight text-slate-900 mt-2 group-hover:text-indigo-600 transition-colors">
                                        {wc.name}
                                    </CardTitle>
                                </div>
                                <div className="h-14 w-14 bg-slate-50 group-hover:bg-indigo-50 rounded-2xl flex items-center justify-center transition-colors duration-500">
                                    <Cpu className="h-7 w-7 text-slate-400 group-hover:text-indigo-600 group-hover:scale-110 transition-all duration-500" />
                                </div>
                            </CardHeader>
                            <CardContent className="p-10 pt-0">
                                <div className="flex items-center justify-between mt-6 bg-slate-50/50 p-4 rounded-2xl border border-transparent group-hover:border-indigo-50 group-hover:bg-white transition-all duration-500">
                                    ...
                                    <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-indigo-600 opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-500">
                                        Initialize <ArrowRight className="h-3.5 w-3.5" />
                                    </div>
                                </div>
                            </CardContent>
                            <div className="absolute top-0 right-0 p-4">
                                <Zap className="h-20 w-20 text-indigo-500/5 -rotate-12 group-hover:rotate-0 transition-transform duration-1000" />
                            </div>
                            {isLastUsed ? (
            ...
            <div className="fixed top-1/2 left-0 w-96 h-96 bg-indigo-500/5 rounded-full blur-[120px] -z-10" />
