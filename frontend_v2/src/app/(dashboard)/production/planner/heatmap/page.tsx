    ...
    <div className="p-6 lg:p-10 space-y-10 bg-surface-2 min-h-screen font-sans selection:bg-info-bg selection:text-primary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {summaryCards.map((stat) => (
          ...
          >
            ...
            <div
              className={cn(
                "p-3 rounded-2xl bg-surface-2 group-hover:bg-surface-1 group-hover:shadow-lg transition-all",
                stat.color,
              )}
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          <Card className="border-none shadow-premium rounded-[2.5rem] overflow-hidden bg-surface-1 ring-1 ring-line">
            <CardHeader className="p-8 border-b border-line">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 text-[9px] font-black uppercase tracking-widest text-content-4">
                  ...
                  <div className="flex items-center gap-1.5">
                    <div className="w-2.5 h-2.5 rounded-full bg-danger-solid animate-pulse" />{" "}
                    CRITICAL
                  </div>
                </div>
              </div>
                      ...
                      <TooltipContent className="bg-surface-3 text-white border-surface-1/10 p-4 rounded-2xl shadow-2xl backdrop-blur-xl">
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-[10px] font-bold uppercase tracking-tight">
                            ...
                            <span className="text-right">
                              {wc.machine_count} Nodes
                            </span>
                            <span className="text-content-4">Active Load:</span>{" "}
                            <span className="text-right">
                              {wc.running_jobs} Jobs
                            </span>
                          </div>
                        </div>
                      </TooltipContent>
        ...
        <div className="lg:col-span-4 space-y-8">
          {/* Bottle Neck Alert */}
          <Card className="border-none shadow-premium bg-surface-3 text-white rounded-[2.5rem] overflow-hidden p-8">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={i} className="space-y-3">
                  ...
                  <div className="h-2 w-full bg-surface-2 rounded-full overflow-hidden shadow-inner">
                    <div
                      className={cn(
