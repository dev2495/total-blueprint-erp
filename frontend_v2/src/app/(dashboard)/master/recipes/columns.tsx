...
export const getColumns = ({ onEdit, onDelete }: ColumnsProps): ColumnDef<ExtrusionRecipe>[] => [
    {
        accessorKey: "film_variant_name",
        header: "Variant",
        cell: ({ row }) => <div className="font-medium">{row.getValue("film_variant_name")}</div>,
    },
    {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return <div>{recipe.thickness_min_micron} - {recipe.thickness_max_micron} μ</div>
        },
    },
    {
        id: "components",
