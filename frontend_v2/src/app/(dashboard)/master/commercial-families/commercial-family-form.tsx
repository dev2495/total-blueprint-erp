...
const formSchema = z.object({
    ...
    default_reporting_group: z.enum(["FILM", "PRINTED", "LAMINATED", "SEMI_FG", "FG", "PACKAGING", "OTHER"]),
...
export function CommercialFamilyForm({ initialData, onSubmit, isLoading }: Props) {
    const form = useForm<CommercialFamilyFormValues, unknown, CommercialFamilySubmitValues>({
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                            ...
                            <div className="space-y-1 leading-none">
                                ...
                                <p className="text-sm text-slate-500">Inactive families stay in history but drop from new naming selectors.</p>
                            </div>
                        </FormItem>
                    )}
                />
