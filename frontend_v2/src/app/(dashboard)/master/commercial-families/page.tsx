    ...
    return (
        <MasterRegistryShell
            ...
            stats={[
                ...
                { label: "Active", value: families.filter((family) => family.active).length, subLabel: "Visible across planner and reports", icon: Layers, toneClassName: "bg-success-bg text-success-fg" },
