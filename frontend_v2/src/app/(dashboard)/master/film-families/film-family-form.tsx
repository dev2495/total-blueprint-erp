...
export function FilmFamilyForm({ initialData, onSubmit, isLoading }: FilmFamilyFormProps) {
    const form = useForm({
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="number" step="0.0001" placeholder="0.9200" {...field} value={field.value as number} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
