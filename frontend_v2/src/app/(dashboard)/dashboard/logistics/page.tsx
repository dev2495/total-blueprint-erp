    ...
    return (
        <div className="space-y-8 pb-10 max-w-7xl mx-auto block xl:px-4">
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Logistics Network</span>
                        </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                {metrics.map(metric => (
                    <Card key={metric.id} className={`group relative overflow-hidden border-none shadow-sm ring-1 bg-white transition-all duration-300 ${metric.ring}`}>
            ...
            <div className="grid gap-8 lg:grid-cols-3">
                ...
                <Card className="lg:col-span-2 border border-slate-200 shadow-sm bg-white rounded-2xl overflow-hidden">
                    <CardHeader className="pb-2">
                ...
                <Card className="border border-slate-200 shadow-sm bg-white rounded-2xl overflow-hidden">
                    ...
                    <CardContent className="space-y-0 p-0">
                        ...
                        {summary.recentChallans.length === 0 && (
                            <p className="text-sm font-medium text-slate-400 text-center py-6 italic">No recent challans found.</p>
                        )}
                    </CardContent>
                </Card>
            </div>
