...
import { Microscope, Palette, Disc, FileText, CheckCircle2 } from "lucide-react"
...
export default function EngineeringDashboard() {
    const { data: stats } = useQuery({
        ...
        queryFn: async () => {
            return {
                metrics: [
                    { label: "Pending Artworks", value: "4", unit: "To Review", trend: 2 },
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black text-slate-900 tracking-tight">Engineering Hub</h1>
                    <p className="text-slate-500 font-medium">Product Design & Master Data Management</p>
                </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                <Card className="border-0 shadow-sm">
                    <CardHeader>
                        ...
                        <CardDescription>Items awaiting engineering sign-off</CardDescription>
                    </CardHeader>
                        ...
                        {[1, 2, 3].map((_, i) => (
                            <div key={i} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-bold text-slate-900">New Template Spec #{100 + i}</p>
                                        <p className="text-xs text-slate-500">For: Apex Foods • Submitted by Sales</p>
                                    </div>
                                </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs font-bold text-blue-700 uppercase">BOMs</span>
                                </div>
                                <p className="text-2xl font-black text-slate-900">100%</p>
                                <p className="text-xs text-slate-500">Routing Coverage</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
