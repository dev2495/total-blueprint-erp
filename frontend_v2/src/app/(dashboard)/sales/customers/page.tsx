  ...
  return (
    <Form {...form}>
      ...
      >
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    className="h-12 rounded-xl border-line bg-surface-2 focus:bg-surface-1 transition-all font-bold"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    className="h-12 rounded-xl border-line bg-surface-2 focus:bg-surface-1 transition-all font-semibold"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="Department, alternate numbers, escalation notes..."
                  className="min-h-[88px] rounded-xl border-line bg-surface-2 pt-3 font-medium"
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        <div className="rounded-[1.5rem] border border-line bg-surface-2 p-5 space-y-5">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-xs font-medium text-content-3">
                Default legal and communication address for this customer.
              </div>
            </div>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Accounts / Dispatch / HO"
                      className="h-12 rounded-xl border-line bg-surface-1 font-semibold"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    className="h-24 rounded-xl border-line bg-surface-1 pt-3 font-medium"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
        ...
        <div className="rounded-[1.5rem] border border-line bg-surface-1 p-5 space-y-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <div className="text-xs font-medium text-content-3">
                Store extra delivery or branch addresses against the same
                customer ledger.
              </div>
            </div>
            <Button
            ...
            fields.map((field, index) => (
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <Input
                    placeholder="Label (e.g. Surat DC)"
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    type="number"
                    min={0}
                    className="h-12 rounded-xl border-line bg-surface-2 font-semibold"
                ...
                <FormItem className="flex items-center justify-between rounded-xl border border-line bg-surface-2 px-4 py-3">
                  <div>
                    ...
                    <div className="text-xs text-content-3">
                      Enable if tax should be deducted for this customer ledger.
                    </div>
                  </div>
                  <FormControl>
                    <Switch
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between rounded-xl border border-line bg-surface-2 px-4 py-3">
                  <div>
                    ...
                    <div className="text-xs text-content-3">
                      Enable if tax should be collected for this customer
                      ledger.
                    </div>
                  </div>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger className="h-12 rounded-xl border-line bg-surface-2 font-semibold">
    ...
    <div className="p-8 lg:p-12 space-y-10 bg-[#f8fafc] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-content-3 font-medium text-sm flex items-center gap-2">
            Tracking {customers?.length || 0} authenticated corporate entities{" "}
      ...
      <div className="relative">
        {isLoading ? (
          ...
          <Card className="border-none shadow-premium rounded-[2rem] overflow-hidden bg-surface-1/70 backdrop-blur-md">
        ...
        {/* Decorative Elements */}
        <div className="absolute -top-10 -right-10 w-64 h-64 bg-primary rounded-full blur-3xl -z-10" />
        <div className="absolute -bottom-10 -left-10 w-64 h-64 bg-primary rounded-full blur-3xl -z-10" />
      </div>
        ...
        <AlertDialogContent className="rounded-[2rem] border-none shadow-2xl p-8">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-content-3 font-medium py-2">
              You are about to permanently decommission the account metadata for{" "}
              <strong>{itemToDelete?.name}</strong>. This operation is
              irreversible within the current ledger cycle.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter className="pt-4">
            <AlertDialogCancel className="rounded-xl border-line bg-surface-2 font-bold uppercase text-[10px]">
              Abort Operation
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={() => {
