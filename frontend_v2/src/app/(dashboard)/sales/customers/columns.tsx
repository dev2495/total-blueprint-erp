    ...
    cell: ({ row }) => (
      <div className="flex items-center justify-end gap-2 px-4">
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 rounded-xl hover:bg-info-bg hover:text-primary transition-all active-scale"
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 rounded-xl hover:bg-danger-bg hover:text-danger-fg transition-all active-scale"
