        ...
        <section className="auth-hero admin">
          <div className="auth-hero-content">
            <div className="auth-badge">
              <ShieldCheck size={16} /> Privileged door
            </div>
            ...
            <p className="auth-copy">
              You are entering the privileged console. User, role, policy, and
              operational changes are logged and reviewed.
            </p>
          </div>
        ...
        <section className="auth-panel-wrap">
          <div className="auth-panel">
            ...
            <p className="auth-form-copy">
              Password and second factor are required before entering the admin
              console.
            </p>
            <div className="auth-notice">
              <AlertTriangle size={16} /> All actions here are logged.
            </div>
