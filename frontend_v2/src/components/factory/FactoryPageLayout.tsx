  ...
  return (
    <div className="min-w-0 bg-[radial-gradient(circle_at_top,#eef4ff,transparent_42%),linear-gradient(180deg,#f8fbff_0%,#f5f7fb_100%)]">
      <div className="px-0 pt-0">
        <div className="rounded-[2rem] border border-surface-1/70 bg-surface-1/72 px-4 py-4 shadow-[0_22px_60px_-46px_rgba(15,23,42,0.45)] backdrop-blur-xl sm:px-5 sm:py-5 lg:px-6">
          <PageHeader
            title={title}
          ...
          {onSearchChange && (
            <div className="relative mt-4 max-w-xl">
              ...
              <Input
                ...
                className="h-12 rounded-2xl border-line bg-surface-1/90 pl-10 shadow-sm transition-all duration-200 hover:shadow-md focus:border-primary"
              />
            </div>
          )}
        </div>
      ...
      <div className="min-w-0 px-0 pb-2 pt-4 sm:pt-5">{children}</div>
    </div>
  );
}
