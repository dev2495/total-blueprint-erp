...
const formSchema = z.object({
  ...
  film_layers: z
    .string()
    .min(1, "Material structure is required (e.g. 12PET/12METPET/100PE)"),
...
export function BlueprintRequestForm({
  onSubmit,
  isLoading,
  initialValues,
}: BlueprintRequestFormProps & { initialValues?: Partial<RequestFormValues> }) {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-4">
                ...
                <FormControl>
                  <Input
                    placeholder="e.g. 1kg Basmati Rice Pouch"
                    {...field}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="col-span-2">
                ...
                <FormControl>
                  <Input type="number" {...field} className="h-10 font-bold" />
                </FormControl>
              </FormItem>
            )}
          />
        ...
        <div className="grid grid-cols-3 gap-4 p-4 bg-surface-2 rounded-xl border border-line relative">
          ...
          <FormField
            control={form.control}
            name="geometry.width_mm"
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-[10px] uppercase text-content-4 font-bold">
                  Width (mm)
                </FormLabel>
                <FormControl>
                  <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="e.g. 12PET / 12METPET / 100PE"
                  {...field}
