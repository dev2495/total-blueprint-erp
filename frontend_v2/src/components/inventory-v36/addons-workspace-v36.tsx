            ...
            <GradientHero
                ...
                actions={
                    <div className="flex items-center gap-2">
                        <Link href="/inventory/grn-v36" className="inline-flex items-center gap-1.5 rounded-xl bg-white px-4 py-1.5 text-xs font-bold text-violet-700 shadow-md hover:bg-violet-50">
